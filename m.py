...
bot = telebot.TeleBot('7448409590:AAEAKvNuWcNXJfDB0rdeImDvjLASdP0f40c')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @freezzzzzzzeꜰ."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @freezzzzzzze")
...
Buy From :-@freezzzzzzze
Official Channel :- https://t.me/freezzzzzzzzze
'''
...
3. MAKE SURE YOU JOINED https://t.me/freezzzzzzzzze OTHERWISE NOT WORK
